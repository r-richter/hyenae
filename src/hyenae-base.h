...
#define HY_ER_DNS_NO_ANSWERS           -3027
#define HY_ER_DNS_QRY_BUFLEN_EXCEED    -3028
#define HY_ER_DNS_ANS_BUFLEN_EXCEED    -3029
#define HY_ER_DNS_QRY_N_BUFLEN_EXCEED  -3030
#define HY_ER_DNS_ANS_N_BUFLEN_EXCEED  -3031
#define HY_ER_DNS_ANS_PT_BUFLEN_EXCEED -3032
#define HY_ER_DNS_ANS_FMT_ERROR        -3033
#define HY_ER_DHCP_MSG_UNSUPPORTED     -3034
